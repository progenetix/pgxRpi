---
title: "Introduction_3_access_cnv_frequency"
author: "Hangjia Zhao"
date: "`r Sys.Date()`"
output: 
  ...
  toc: true
vignette: >
  %\VignetteIndexEntry{Introduction_3_access_cnv_frequency}
...
* `domain`: A string specifying the domain of the query data resource. For CNV frequency data, the value should be either `"http://progenetix.org"` or `"https://cancercelllines.org"`.
