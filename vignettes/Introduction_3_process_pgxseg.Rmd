...
The returned object is same as the CNV frequency object with "pgxfreq" format returned by pgxLoader function (format details see the vignette [Introduction_2_loadfrequency](https://htmlpreview.github.io/?https://github.com/progenetix/pgxRpi/blob/main/vignettes/Introduction_2_loadfrequency.html). It contains two slots 'meta' and 'data'.
...
In this matirx, `gain_frequency` and `loss_frequency` indicate the percentage (%) of samples from the corresponding group_id for gains and 
losses overlapping the genomic interval, respectively.
