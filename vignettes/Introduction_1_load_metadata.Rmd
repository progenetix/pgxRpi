...
The following query retrieves information about all retinoblastoma samples in Progenetix, utilizing a specific filter based on an [NCIt code](https://ncit.nci.nih.gov) as a disease identifier.
