...
type, output, filters, codematches, skip, limit

## Across genomic bins 

```{r}
cnv_matrix <- pgxLoader(type="v", output="pgxmatrix", filters = "NCIT:C9245")
```
...
```{r}
biosamples <- pgxLoader(type="b", filters = "NCIT:C4017",codematches = TRUE, limit=10)
