...
```{r}
unique(biosamples[biosamples$histological_diagnosis_id != "NCIT:C3059",'biosample_id'])
```
...
By default, it returns all available profiles (limit=0), so the query may spend 1-2 minutes 
