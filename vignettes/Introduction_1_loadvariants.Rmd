...
available options are NULL, "pgxseg" ,"pgxmatrix", "coverage" or "seg" ; When the parameter `type` is "frequency", available options are "pgxseg" or "pgxmatrix" .
...
Default is FALSE. 
* `limit` Integer to specify the number of returned samples/profiles for each filter.  
* `skip` Integer to specify the number of skipped samples/profiles for each filter. 
