...
```{r}
biosamples <- pgxLoader(type="b", filters = "NCIT:C3512")
...
```{r}
biosamples_2 <- pgxLoader(type="b", filters = "NCIT:C3512",
...
```{r}
biosamples_3 <- pgxLoader(type="b", filters = "NCIT:C3512",skip=0, limit = 1000)
...
```{r}
biosamples_4 <- pgxLoader(type="b", filters = "NCIT:C3512",codematches = TRUE)
...
```{r}
biosamples_5 <- pgxLoader(type="b", filters = c("NCIT:C3512","PMID:24174329"), 
                          filterLogic = "AND")
```
...
```{r}
individuals <- pgxLoader(type='i',filters='NCIT:C3270')
...
```{r}
individual <- pgxLoader(type='i',individual_id = 'pgxind-kftx26ml', biosample_id="pgxbs-kftvh94d")
...
```{r}
total.individuals <- pgxLoader(type='i',filters='NCIT:C3270',
                               individual_id = 'pgxind-kftx26ml',
