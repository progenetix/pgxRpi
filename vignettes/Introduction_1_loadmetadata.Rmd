...
```{r}
biosamples_2 <- pgxLoader(type="b", filters = "NCIT:C3512",codematches = TRUE,
...
```{r}
individuals <- pgxLoader(type='i',filters='NCIT:C3270',codematches = TRUE)
...
```{r}
individual <- pgxLoader(type='i',individual_id = 'pgxind-kftx26ml')
