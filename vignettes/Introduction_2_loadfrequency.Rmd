...
Choose 9 NCIT codes of interests that correspond to different tumor types
...
In the pgxmatrix matrix, `group id` is the same as that in pgxseg matrix. It's followed by all “gain status” columns (3102 intervals) plus all “loss status” columns (3102 intervals).
